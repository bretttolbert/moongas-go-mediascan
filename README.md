...
```bash
go get github.com/bretttolbert/moongas-mediascan-go
cd ~/go/src/github.com/bretttolbert/moongas-mediascan-go/ && go install
```
...
```bash
go run github.com/bretttolbert/moongas-mediascan-go mediascan-config.yml files.yml
```
